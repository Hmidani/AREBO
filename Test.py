...
while simulation_app.is_running():
    ...
    if my_world.is_playing():
        ...
        command_input = keyboard_controller.base_command
       
        robot_actions = my_controller.forward(command=command_input)
       
        my_jetbot.apply_wheel_actions(robot_actions)
